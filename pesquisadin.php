        ...
        <div class="container-fluid">
            ...
            <?php
                ...
                if(!empty($_POST['pesquisa'])){
                    ...
                    $data=$_POST['pesquisa'];
                    $sql="SELECT * FROM imoveistable WHERE id LIKE '%$data%' 
                    OR tipo LIKE '%$data%' 
                    OR objetivo LIKE '%$data%' 
                    OR bairro LIKE '%$data%' 
                    OR vagas LIKE '%$data%' 
                    OR quartos LIKE '%$data%'
                    OR metragem LIKE '%$data%' 
                    OR banheiros LIKE '%$data%'
                    OR descricao LIKE '%$data%'
                    OR valor LIKE '%$data%'";
                }else{
                    echo "não temos nada, trazer todos os registros";

                    $sql= "SELECT * FROM imoveistable ORDER BY id DESC";
                }
                ...
                if(mysqli_num_rows($result)>0){
                    ...
                    echo "<br><a href='imprimir.php'>Voltar</a>";
                }
